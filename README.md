...
* [X] List anything else that you can get done to improve the app functionality!
	I included an extra step in the when (switch) statement that does not display
	a gif until the "let's roll" button has been click once.
## Video Walkthrough 
...
Copyright 2018 <Raul Rivero Rubio>
